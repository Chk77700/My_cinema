<?php
if(isset($_SESSION["admin"]) && $_SESSION["admin"] == 'cinema2020') {
    ...
    function HtmlInput ($rows, $conn) {
        ...
        foreach($rows as $row) {
            ...
            $date = implode('/', array_reverse(explode('-', (explode(' ' ,$row['date_inscription'])[0]))));   // SOURCE https://openclassrooms.com/forum/sujet/explode-implode-30420
            ...
            <a href='member.php?id=$idmembre'><img src=\"src/Mobile best Wallpaper Download\"></a>
            <p>
            VILLE : $ville<br/>
            Code Postal : $cp<br/>
